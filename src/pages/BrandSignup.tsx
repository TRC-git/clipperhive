...
import BrandRegistrationForm from '@/components/register/BrandRegistrationForm';
      ...
      <main className="pt-36 relative overflow-hidden flex-1 flex flex-col">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col">
          ...
          <div className="text-center mb-8 animate-fade-in opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            <div className="p-5 inline-block mx-auto">
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-charcoal-800 dark:text-white">
                Brand <span className="text-honey-500">Registration</span>
              </h1>
              <p className="text-lg max-w-2xl mx-auto text-charcoal-600 dark:text-charcoal-300">
                Join our marketplace and find talented creators for your brand
              </p>
            </div>
          </div>
          
          {/* Registration Form */}
          <div className="max-w-4xl mx-auto w-full mb-10 animate-scale-in opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
            <BrandRegistrationForm />
          </div>
          
          {/* Already have an account */}
          <div className="text-center text-sm text-charcoal-600 dark:text-charcoal-400 my-6 animate-fade-in opacity-0" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
