...
import { BrandLoginValues, brandLoginSchema } from './loginFormSchema';
const BrandLoginForm: React.FC = () => {
  const navigate = useNavigate();
  const form = useForm<BrandLoginValues>({
  ...
  function onSubmit(values: BrandLoginValues) {
  ...
  return <div className="relative">
      ...
      <Card className="border-0 bg-white/80 dark:bg-charcoal-800/80 backdrop-blur-lg shadow-lg relative z-0">
        <CardHeader className="pb-2">
          <CardTitle className="text-zinc-700 text-left text-base">Brand Sign In</CardTitle>
        </CardHeader>
